...
class OpenAIServingChat(OpenAIServing):
    ...
    async def create_chat_completion(
        ...
        if request.stream:
            ...
            # try:
            #     # Collect all text generated by the asynchronous generator
            #     texts = []
            #     async for text in result_generator:
            #         texts.append(text)
            #     full_text = "".join(texts)  # Assuming you want to concatenate all generated texts
            #
            #     # Now apply the guardrail check to the concatenated text
            #     raw_llm_output, validated_output, *rest = toxic_guard.parse(llm_output=full_text)
            #
            #     # Return the validated or fixed output
